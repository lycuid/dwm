...
static const char *       fonts[]        = {"FiraCode Nerd Font-10"};
...
static const int   tpadding =
    3; // padding (in pixels) for tags' display on statusbar
...
static const char *scratchpad_term[] = {"t",  "st",     "-t", "scratchpad-term",
                                        "-g", "110x30", NULL};
static const char *scratchpad_fm[]   = {
    "f", "st", "-t", "scratchpad-fm", "-g", "110x30", "-e", "vifm", NULL};
static const char *scratchpad_nm[] = {
    "n", "st", "-t", "scratchpad-nm", "-g", "110x30", "-e", "nmtui", NULL};
